...
import oedinnn.waste.analyzer.MLKitBarcodeAnalyzer
import oedinnn.waste.analyzer.ScanningResultListener
import oedinnn.waste.analyzer.ZXingBarcodeAnalyzer
import oedinnn.waste.databinding.ActivityBarcodeScanningBinding
...
class BarcodeScanningActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.backArrow.setOnClickListener {
            val intent = Intent(this@BarcodeScanningActivity, ResultAmbil::class.java)
            intent.flags =
